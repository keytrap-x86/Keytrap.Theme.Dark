    ...
    public static class GeometryHelper
    {
        public static Geometry GetRoundRectangle(Rect baseRect, Thickness thickness, CornerRadius cornerRadius)
        {
            ...
            if (topLeftRect.Right > topRightRect.Left)
            {
                ...
                topRightRect = new Rect(baseRect.Left + newWidth, topRightRect.Location.Y,
                    Math.Max(0.0, baseRect.Width - newWidth), topRightRect.Height);
            }
            ...
            if (topRightRect.Bottom > bottomRightRect.Top)
            {
                ...
                topRightRect = new Rect(topRightRect.Location.X, topRightRect.Location.Y, topRightRect.Width,
                    newHeight);
                bottomRightRect = new Rect(bottomRightRect.Location.X, baseRect.Top + newHeight, bottomRightRect.Width,
            ...
            if (bottomRightRect.Left < bottomLeftRect.Right)
            {
                ...
                bottomRightRect = new Rect(baseRect.Left + newWidth, bottomRightRect.Location.Y,
                    Math.Max(0.0, baseRect.Width - newWidth), bottomRightRect.Height);
            }
            ...
            if (bottomLeftRect.Top < topLeftRect.Bottom)
            {
                ...
                bottomLeftRect = new Rect(bottomLeftRect.Location.X, baseRect.Top + newHeight, bottomLeftRect.Width,
                    Math.Max(0.0, baseRect.Height - newHeight));
            }
